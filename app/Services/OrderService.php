...
class OrderService
{
    ...
    public function createOrder(array $data): ?Model
    {
        return DB::transaction(function () use ($data) {
            ...
            // Add shipping cost: Dhaka = 70 BDT, Outside Dhaka = 120 BDT
            $shippingCost = $data['shipping_amount'] ?? (isset($data['district']) && str_contains(strtolower($data['district']), 'dhaka') ? 70 : 120);
            $total += $shippingCost;
