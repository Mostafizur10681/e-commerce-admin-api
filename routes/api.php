...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:admin')->prefix('admin')->group(function () {
        ...
        Route::post('/categories/{id}', [AdminController::class, 'categoriesUpdate']); // multipart/form-data upload via _method spoofing
        Route::delete('/categories/{id}', [AdminController::class, 'categoriesDestroy']);

        // Sub Category Management
        Route::get('/sub-categories', [AdminController::class, 'subCategoriesIndex']);
        Route::post('/sub-categories', [AdminController::class, 'subCategoriesStore']);
        Route::get('/sub-categories/{id}', [AdminController::class, 'subCategoriesShow']);
        Route::put('/sub-categories/{id}', [AdminController::class, 'subCategoriesUpdate']);
        Route::post('/sub-categories/{id}', [AdminController::class, 'subCategoriesUpdate']);
        Route::delete('/sub-categories/{id}', [AdminController::class, 'subCategoriesDestroy']);
